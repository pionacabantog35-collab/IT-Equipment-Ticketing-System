...
<body>
    ...
    <div class="slider">
        <div class="slides">
            ...
            <div class="slide">
                <img src="yet-another-image.jpg" alt="Yet Another Image" class="auimage">
            </div>
        </div>
...
<div class="welcome-container">
  ...
  <!-- Feature Section -->
        ...
        <div class="container">
            ...
            <a href="user-equipmentmanagement.php" class="card">
                <img src="equipments.png" alt="Equipment">
                 <p class="card-title">Equipments</p>
                
            </a>
            <a href="user-ticketmanagement.php" class="card">
