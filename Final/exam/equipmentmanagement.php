...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <ul>
            <li><a href="index-page.php">Home Page</a></li>
            <li><a href="accounts-management.php">Accounts Management</a></li>
            <li><a href="ticket-management.php">Ticket Management</a></li>
    ...
    <div class="main-content">
        ...
        <div class="add-container">
            <a href="add-equipment.php" class="btn btn-add">Add Equipment</a>
        </div>
        ...
        function buildTable($result) {
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<a href='update-equipment.php?assetnumber=" . urlencode($row['assetnumber']) . "' class='btn btn-update'>Update</a>";
                    echo "<a href='delete-equipment.php?assetnumber=" . urlencode($row['assetnumber']) . "' class='btn btn-cancel' onclick='return confirm(\"This equipment is about to be deleted\");'>Delete</a>";
                    echo "</div>";
                    echo "</td>";
                    echo "</tr>";
                }
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btnsearch'])) {
            ...
            $sql = "SELECT * FROM tblequipments WHERE assetnumber LIKE ? OR serialnumber LIKE ? 
                    OR type LIKE ? OR branch LIKE ? OR status LIKE ? OR createdby LIKE ? ORDER BY assetnumber";
    ...
    <script>
        ...
        <?php if (isset($_SESSION['message'])): ?>
            document.addEventListener('DOMContentLoaded', function() {
                showPopup("<?php echo addslashes($_SESSION['message']); ?>");
            });
